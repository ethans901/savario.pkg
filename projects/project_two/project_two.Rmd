...
```
The adjusted R value is significantly higher on this graph versus the first graph we made. There are also higher signifigance codes. When looking at the 
```
